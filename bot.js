  ...
  client.on("message", message => {
    if (message.content === "ahelp") {
     const embed = new Discord.RichEmbed() 
       ...
       asetname | تغير اسم بوت

       asetava | تغير صورة بوت

       asetg   | تغير بلاينق بوت

       aleave  | لاخراج بوت من سيرفر
       
       asetw   | لتغير وتشنيق بوت

       asetl   | لتغير ليستينق بوت

       asets   | لتغير ستريمينق بوت
